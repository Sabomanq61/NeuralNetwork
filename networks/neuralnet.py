...
images = sorted(glob.glob('NeuralNetwork/dataset/images/*.jpg'))
masks  = sorted(glob.glob('NeuralNetwork/dataset/masks/*.png'))
...
unet_like.save_weights('SemanticSegmentation/networks/unet_like')
